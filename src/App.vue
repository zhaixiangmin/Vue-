<template>
  <div id="app">
    ...
    <div>
      <button @click="$router.go(-1)" type="button">向后</button>
      <button @click="$router.go(1)" type="button">向前</button>
    </div>
...
export default {
  ...
  methods: {
    navigate: function () {
      ...
      // const id = '963';
      // this.$router.push({ name: 'user', params: { id } }); // /user/897
      // this.$router.push({ path: `/user/${id}` }); // /user/897
